      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">Stay up to date with our latest posts and updates</p>
          </div>

          <div className="mb-12">
            <div className="bg-mg-muted rounded-xl p-4 flex justify-center">
              <iframe
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <a 
              ...
              className="flex items-center justify-center gap-3 bg-mg-muted hover:bg-mg-gold hover:text-mg-dark text-mg-light p-6 rounded-xl transition-all duration-200 group"
            >
              <i className="fab fa-instagram text-2xl text-mg-gold group-hover:text-mg-dark"></i>
            ...
            <a 
              ...
              className="flex items-center justify-center gap-3 bg-mg-muted hover:bg-mg-gold hover:text-mg-dark text-mg-light p-6 rounded-xl transition-all duration-200 group"
            >
              <i className="fab fa-facebook text-2xl text-mg-gold group-hover:text-mg-dark"></i>
            ...
            <a 
              ...
              className="flex items-center justify-center gap-3 bg-mg-muted hover:bg-mg-gold hover:text-mg-dark text-mg-light p-6 rounded-xl transition-all duration-200 group"
            >
              <i className="fab fa-youtube text-2xl text-mg-gold group-hover:text-mg-dark"></i>
            ...
            <a 
              ...
              className="flex items-center justify-center gap-3 bg-mg-muted hover:bg-mg-gold hover:text-mg-dark text-mg-light p-6 rounded-xl transition-all duration-200 group"
            >
              <i className="fab fa-spotify text-2xl text-mg-gold group-hover:text-mg-dark"></i>
