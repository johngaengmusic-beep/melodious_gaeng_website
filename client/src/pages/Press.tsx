...
export default function Press() {
  return (
    <div className="pt-16 min-h-screen bg-mg-sand">
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-mg-brown mb-6">Press</h1>
            <p className="text-xl text-mg-brown/70 max-w-2xl mx-auto">
              Media coverage, reviews, and press resources for Melodious Gaeng.
            </p>
          </div>

          <div className="max-w-4xl mx-auto space-y-8">
            <div className="bg-mg-brown text-mg-cream p-8 rounded-xl">
              <div className="flex items-start gap-4">
                <i className="fas fa-quote-left text-mg-terra text-3xl mt-1 flex-shrink-0"></i>
                <div>
            ...
            <div className="bg-mg-cream border border-mg-dust p-8 rounded-xl">
              <h3 className="text-2xl font-heading font-bold text-mg-brown mb-4">About Melodious Gaeng</h3>
              <p className="text-mg-brown/80 font-body leading-relaxed mb-4">
              ...
              <p className="text-mg-brown/80 font-body leading-relaxed">
            ...
            <div className="bg-mg-cream border border-mg-dust p-8 rounded-xl text-center">
              <h3 className="text-2xl font-heading font-bold text-mg-brown mb-4">Press Inquiries</h3>
              <p className="text-mg-brown/70 font-body mb-6">
                For press inquiries, interviews, or media requests, please reach out via email.
              </p>
              <a 
                href="mailto:johngaengmusic@gmail.com" 
                className="inline-flex items-center gap-2 bg-mg-terra hover:bg-orange-800 text-mg-cream px-8 py-3 rounded-lg font-heading font-bold text-lg transition-colors"
              >
